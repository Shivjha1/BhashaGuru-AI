  ...
  return (
    <main className="dashboard-page">
      ...
      <section className="dashboard-shell">
        ...
        <div className="dashboard-grid teacher-actions"><Link className="dashboard-card action-card" href="/teacher/lessons"><span className="card-icon">📚</span><h2>Manage lessons</h2><p>Create, edit, and open your database-backed lessons.</p><span className="text-link">Open lesson manager →</span></Link><div className="dashboard-card action-card"><span className="card-icon">👥</span><h2>Students</h2><p>Keep your class learning content organized in one place.</p><span className="muted">Student insights from activity data.</span></div><div className="dashboard-card action-card"><span className="card-icon">📊</span><h2>Performance</h2><p>Use lesson and quiz activity to guide your next lesson.</p><span className="muted">Performance reports will appear here.</span></div></div>
